...
public class AdMobGameReward : MonoBehaviour
{
//やること
    //1.リワード広告IDの入力
    ...
    public TextMeshProUGUI coinAddText;//coinを表示するtext
...
//広告がダウンロード失敗して表示されない場合
        ...
        if (rewardeFlag1 == true && rewardeFlag == true)
        {
            ...
            afterAdPanel.GetComponent<DoGAfterReward>().coinAddText.text = GameManager.singleton.coinNum.ToString();
            afterAdPanel.GetComponent<DoGAfterReward>().AfterReward();
            SpinnerPanel.SetActive(false);
