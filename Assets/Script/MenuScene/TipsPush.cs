...
public class TipsPush : MonoBehaviour
{
    ...
    private string channelId = "kakezan_localpush_channel";//通知チャンネルIDの設定

    private string pushTitle = "かけざん";
...
#if UNITY_ANDROID
		//プッシュ通知用のチャンネルを作成・登録
		AndroidLocalPushNotification.RegisterChannel(channelId, "かけざん", "ログインボーナスを通知します");
#endif

        //テキスト本文候補の設定
        tipsTexts[0]  = "ログインボーナスゲット";
        tipsTexts[1]  = "ログインで１５０コインピヨ";
        tipsTexts[2]  = "ログインボーナスピヨ";
        tipsTexts[3]  = "ログインまってるピヨ";
        tipsTexts[4]  = "ログインボーナスゲット";
        tipsTexts[5]  = "ログインボーナスあるピヨ";
        /*
        tipsTexts[6]  = "小技7の情報";
        tipsTexts[7]  = "小技8の情報";
        tipsTexts[8]  = "小技9の情報";
